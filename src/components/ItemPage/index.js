...
class ItemPage extends Component {
  ...
  handleSubmission(e) {
    ...
    // console.log(this);
    this.props.addNote(
      this.props.location.state.titles,
      this.props.location.state.harga,
      this.props.location.state.uri
    ); // here we use the addNote from the component’s props
  ...
  render() {
    ...
    let img1 = (
      <img
        ...
        src={"../sneakers_191107_000" + naom.toString(10) + ".jpg"}
      />
    );
    ...
    let img2 = (
      <img
        style={{ display: "block", width: "100%" }}
        src={"../Watch_191107_000" + naom.toString(10) + ".jpg"}
      />
    );
    ...
    let img3 = (
      <img
        style={{ display: "block", width: "100%" }}
        src={"../Hat_191107_000" + naom.toString(10) + ".jpg"}
      />
    );
      ...
      <div>
        <div className="itemPageWrapper">
          <div className="itemImgWrapper">
            <img
              className="image"
              src={"../" + this.props.location.state.uri}
            />
          </div>
          <div className="itemInfoWrapper">
            ...
            <p className="description">{this.props.location.state.desc}</p>
